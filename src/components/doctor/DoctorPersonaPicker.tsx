  ...
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-6 py-12 md:px-12 md:py-16">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold text-ink md:text-3xl">เลือกบัญชีผู้ใช้</h1>
        ...
        {personas.map(({ doctor, queueSize }) => (
          ...
          >
            <GlassCard className="flex h-full flex-col gap-3 p-5 transition-all group-hover:-translate-y-1 group-hover:shadow-lg">
              ...
              <div>
                <div className="text-base font-semibold text-ink">{doctor.name}</div>
              ...
              <div className="mt-auto flex items-center justify-between border-t border-line/40 pt-3 text-[11px] text-muted-foreground">
